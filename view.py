...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.student_score_label = QtWidgets.QLabel(self.centralwidget)
        self.student_score_label.setGeometry(QtCore.QRect(46, 169, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.student_score_label.setFont(font)
        self.student_score_label.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.student_score_label.setAlignment(QtCore.Qt.AlignCenter)
        self.student_score_label.setObjectName("student_score_label")
        self.score_enter_button = QtWidgets.QPushButton(self.centralwidget)
        self.score_enter_button.setGeometry(QtCore.QRect(100, 210, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.score_clear_button.setGeometry(QtCore.QRect(230, 210, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.score_table.setGeometry(QtCore.QRect(40, 290, 361, 151))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.score_table.setFont(font)
        self.score_table.setObjectName("score_table")
        self.calculate_grade_button = QtWidgets.QPushButton(self.centralwidget)
        self.calculate_grade_button.setGeometry(QtCore.QRect(150, 450, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.calculate_grade_button.setFont(font)
        self.calculate_grade_button.setObjectName("calculate_grade_button")
        self.error_label = QtWidgets.QLabel(self.centralwidget)
        self.error_label.setGeometry(QtCore.QRect(40, 240, 361, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.student_score_label.setText(_translate("mainWindow", "Student Scores"))
        ...
        self.calculate_grade_button.setText(_translate("mainWindow", "Calculate Grades"))
